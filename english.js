...
function checkAnswer(selectedIndex) {
    ...
    if (selectedIndex === correctIndex) {
        currentScore++;
        timeLeft += 3; // Add extra 3 seconds for a correct answer
        feedbackElement.textContent = "🎉 Correct! +3s";
        feedbackElement.style.color = "green";
        selectedButton.style.backgroundColor = "green"; // Correct answer turns green
        selectedButton.style.color = "white";
    } else {
        feedbackElement.textContent = "❌ Wrong answer.";
        feedbackElement.style.color = "red";
        selectedButton.style.backgroundColor = "red"; // Wrong answer turns red
        selectedButton.style.color = "white";
        correctButton.style.backgroundColor = "green"; // Show correct answer in green
...
function endQuiz() {
    ...
    if (playerName) {
        ...
        const playerData = { name: playerName, score: Number(currentScore) };
